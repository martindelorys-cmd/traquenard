...
const DEFIS: Record<string, { id: number; text: string; points: number; emoji: string }[]> = {
  chill: [
    ...
    { id: 111, text: "Faire un origami et l'offrir à quelqu'un", points: 10, emoji: "🎀" },
    { id: 112, text: "Apprendre 3 mots dans une langue random et les utiliser", points: 10, emoji: "🌍" },
    { id: 113, text: "Dessiner le portrait d'un pote en 2 minutes", points: 10, emoji: "🎨" },
    { id: 114, text: "Faire une liste de 5 choses pour lesquelles tu es reconnaissant", points: 5, emoji: "🙏" },
    { id: 115, text: "Proposer ton aide à un inconnu qui porte des sacs", points: 10, emoji: "🛍️" },
    { id: 116, text: "Imiter ton animal préféré pendant 20 secondes", points: 10, emoji: "🐾" },
    { id: 117, text: "Trouver un trèfle à 4 feuilles (ou chercher 5 min)", points: 10, emoji: "🍀" },
    { id: 118, text: "Faire deviner un film en le mimant", points: 10, emoji: "🎬" },
    { id: 119, text: "Écrire un petit mot doux et le laisser quelque part pour un inconnu", points: 15, emoji: "📝" },
    { id: 120, text: "Apprendre une nouvelle blague et la raconter à 3 personnes", points: 10, emoji: "😂" },
    { id: 121, text: "Faire un selfie avec ton plat préféré", points: 5, emoji: "🍕" },
    { id: 122, text: "Marcher 5 minutes sans regarder ton téléphone", points: 5, emoji: "📵" },
    { id: 123, text: "Donner un surnom sympa à un pote et l'utiliser toute la journée", points: 10, emoji: "🏷️" },
    { id: 124, text: "Faire une roue ou un grand écart (si tu peux !)", points: 15, emoji: "🤸" },
    { id: 125, text: "Envoyer une story avec ta plus belle grimace joyeuse", points: 10, emoji: "🥰" },
    { id: 126, text: "Inventer un handshake secret avec un pote", points: 10, emoji: "🤝" },
    { id: 127, text: "Complimenter 3 inconnus sur leur style", points: 15, emoji: "👗" },
    { id: 128, text: "Apprendre à dire bonjour dans 5 langues", points: 10, emoji: "🗣️" },
    { id: 129, text: "Faire un câlin à un proche sans raison", points: 5, emoji: "🤗" },
    { id: 130, text: "Créer une playlist en 3 minutes pour un ami", points: 10, emoji: "🎧" },
  ],
  normal: [
    ...
    { id: 211, text: "Faire un TikTok de 15 sec sur le moment présent", points: 20, emoji: "📱" },
    { id: 212, text: "Échanger un vêtement avec un pote pendant 10 minutes", points: 20, emoji: "👕" },
    { id: 213, text: "Te faire passer pour un touriste perdu et demander ton chemin", points: 15, emoji: "🗺️" },
    { id: 214, text: "Faire un concours de grimaces avec un inconnu consentant", points: 15, emoji: "🤪" },
    { id: 215, text: "Marcher comme un robot pendant 1 minute en public", points: 20, emoji: "🤖" },
    { id: 216, text: "Demander à quelqu'un de te prendre en photo dans une pose ridicule", points: 15, emoji: "📸" },
    { id: 217, text: "Faire deviner un animal en imitant son cri à voix haute", points: 15, emoji: "🦁" },
    { id: 218, text: "Te présenter à un inconnu avec un faux nom de star", points: 20, emoji: "⭐" },
    { id: 219, text: "Improviser une pub pour un objet random pendant 30s", points: 20, emoji: "📺" },
    { id: 220, text: "Faire un mini défilé de mode improvisé dans la rue", points: 25, emoji: "💃" },
    { id: 221, text: "Demander à un inconnu de te donner un conseil de vie", points: 15, emoji: "🧠" },
    { id: 222, text: "Chanter le générique d'un dessin animé à voix haute", points: 15, emoji: "📺" },
    { id: 223, text: "Faire une interview improvisée d'un pote comme à la télé", points: 15, emoji: "🎥" },
    { id: 224, text: "Proposer un check à 5 inconnus différents", points: 20, emoji: "🙌" },
    { id: 225, text: "Te déguiser avec ce que tu as sous la main pendant 10 min", points: 20, emoji: "🦸" },
    { id: 226, text: "Faire un concours de celui qui tient le plus sur un pied", points: 15, emoji: "🦩" },
    { id: 227, text: "Réciter l'alphabet à l'envers devant quelqu'un", points: 15, emoji: "🔤" },
    { id: 228, text: "Faire semblant d'être un guide touristique pendant 2 min", points: 20, emoji: "🧭" },
    { id: 229, text: "Demander à un inconnu son meilleur conseil pour draguer", points: 20, emoji: "💘" },
    { id: 230, text: "Faire une danse robot devant un magasin", points: 20, emoji: "🪩" },
  ],
  chaud: [
    ...
    { id: 311, text: "Te faire passer pour un influenceur dans un magasin", points: 40, emoji: "🤳" },
    { id: 312, text: "Proposer un date fictif à quelqu'un dans la rue", points: 45, emoji: "🌹" },
    { id: 313, text: "Faire un concours de cris dans un lieu public", points: 35, emoji: "📢" },
    { id: 314, text: "Demander à un inconnu de te coiffer pendant 1 minute", points: 40, emoji: "💇" },
    { id: 315, text: "Te lancer dans un slam improvisé devant des inconnus", points: 45, emoji: "🎤" },
    { id: 316, text: "Imiter un commentateur sportif sur une scène banale 1 minute", points: 35, emoji: "🎙️" },
    { id: 317, text: "Faire un appel vidéo à un inconnu de ton répertoire au hasard", points: 50, emoji: "📞" },
    { id: 318, text: "Te déguiser en super-héros avec des sacs plastiques 10 min", points: 40, emoji: "🦸‍♂️" },
    { id: 319, text: "Organiser un flashmob improvisé avec 3 inconnus", points: 50, emoji: "🕺" },
    { id: 320, text: "Faire croire à un pote que tu as gagné au loto en vrai pendant 5 min", points: 35, emoji: "🎰" },
    { id: 321, text: "Te présenter comme le maire de la ville à un commerçant", points: 40, emoji: "🏛️" },
    { id: 322, text: "Faire un strip-tease (habillé) sur une chanson improvisée", points: 45, emoji: "🔥" },
    { id: 323, text: "Demander à un parfait inconnu d'être ton témoin de mariage fictif", points: 40, emoji: "📜" },
    { id: 324, text: "Réciter un poème d'amour à voix haute dans un lieu public", points: 40, emoji: "📖" },
    { id: 325, text: "Te faire passer pour un journaliste et interviewer 3 personnes", points: 45, emoji: "🎙️" },
    { id: 326, text: "Faire la manche pendant 5 minutes pour offrir l'argent à un pote", points: 40, emoji: "💰" },
    { id: 327, text: "Crier I love Traquenard au milieu d'une foule", points: 35, emoji: "📣" },
    { id: 328, text: "Faire semblant de pleurer devant un inconnu pendant 30s", points: 45, emoji: "😭" },
    { id: 329, text: "Demander en mariage ton reflet dans une vitrine devant témoins", points: 50, emoji: "💍" },
    { id: 330, text: "Improviser un discours de remerciement aux Oscars en pleine rue", points: 40, emoji: "🏆" },
  ],
  bureau: [
    ...
    { id: 411, text: "Mettre une sonnerie ridicule et oublier d'éteindre ton tel en réunion", points: 20, emoji: "📳" },
    { id: 412, text: "Répondre uniquement par citations de films pendant 1h", points: 25, emoji: "🎞️" },
    { id: 413, text: "Demander un brainstorming sur la pause café idéale", points: 15, emoji: "☕" },
    { id: 414, text: "Glisser le mot disruptif dans 3 phrases différentes", points: 20, emoji: "💥" },
    { id: 415, text: "Faire un tour de table improvisé sur ton plat préféré", points: 15, emoji: "🍽️" },
    { id: 416, text: "Proposer un team building en pleine réunion sérieuse", points: 20, emoji: "🎉" },
    { id: 417, text: "Te présenter comme stagiaire alors que tu ne l'es pas", points: 25, emoji: "🎓" },
    { id: 418, text: "Demander si la réunion pourrait être un email à voix haute", points: 20, emoji: "📩" },
    { id: 419, text: "Faire une métaphore sportive pour expliquer une tâche simple", points: 15, emoji: "⚽" },
    { id: 420, text: "Mettre un fond d'écran ridicule en visio sans prévenir", points: 20, emoji: "🖥️" },
    { id: 421, text: "Saluer tout le monde façon PDG en arrivant au bureau", points: 15, emoji: "🤵" },
    { id: 422, text: "Glisser une private joke incomprise dans un mail pro", points: 20, emoji: "😏" },
    { id: 423, text: "Demander un badge VIP pour la machine à café", points: 15, emoji: "🏅" },
    { id: 424, text: "Faire un récap inutilement long d'une tâche de 2 minutes", points: 20, emoji: "📋" },
    { id: 425, text: "Répondre présent à l'appel comme à l'école", points: 15, emoji: "🙋‍♂️" },
    { id: 426, text: "Proposer un nom d'équipe ridicule pour ton service", points: 20, emoji: "🏷️" },
    { id: 427, text: "Glisser le mot pivoter dans une conversation anodine", points: 15, emoji: "🔄" },
    { id: 428, text: "Faire un signe de victoire après chaque tâche accomplie", points: 15, emoji: "✌️" },
    { id: 429, text: "Demander un retour d'expérience sur la météo du jour", points: 15, emoji: "🌦️" },
    { id: 430, text: "Conclure un mail pro par Sportivement plutôt que Cordialement", points: 20, emoji: "🏃" },
  ],
  soiree: [
    ...
    { id: 511, text: "Faire deviner ton métier en mimant pendant 1 minute", points: 25, emoji: "🎭" },
    { id: 512, text: "Organiser un mini concours de la blague la plus nulle", points: 25, emoji: "😂" },
    { id: 513, text: "Demander au groupe d'à côté de trinquer avec vous", points: 25, emoji: "🥃" },
    { id: 514, text: "Faire un concours de tchin tchin le plus original", points: 20, emoji: "🍻" },
    { id: 515, text: "Inviter un inconnu à se joindre à une partie de votre table", points: 30, emoji: "🎲" },
    { id: 516, text: "Faire deviner une chanson en la fredonnant faux exprès", points: 25, emoji: "🎶" },
    { id: 517, text: "Proposer un cul sec symbolique avec un verre d'eau", points: 20, emoji: "💧" },
    { id: 518, text: "Organiser une mini battle de danse avec tes potes", points: 35, emoji: "🕺" },
    { id: 519, text: "Te faire passer pour le DJ et annoncer la prochaine chanson", points: 30, emoji: "🎧" },
    { id: 520, text: "Faire un cheers avec un groupe d'inconnus", points: 25, emoji: "🍾" },
    { id: 521, text: "Raconter ton pire date au groupe en story", points: 25, emoji: "💔" },
    { id: 522, text: "Faire deviner ton signe astro sans le dire directement", points: 20, emoji: "✨" },
    { id: 523, text: "Organiser un quiz éclair sur le groupe entre vous", points: 25, emoji: "❓" },
    { id: 524, text: "Convaincre le groupe de faire un cri de guerre avant de trinquer", points: 25, emoji: "🗣️" },
    { id: 525, text: "Faire un selfie de groupe avec un inconnu dedans", points: 25, emoji: "🤳" },
    { id: 526, text: "Proposer un pari amical sur le prochain client qui entre", points: 20, emoji: "🎯" },
    { id: 527, text: "Faire une dédicace façon radio à quelqu'un dans la salle", points: 30, emoji: "📻" },
    { id: 528, text: "Lancer un défi cul sec collectif (avec un soft si besoin)", points: 25, emoji: "🥤" },
    { id: 529, text: "Faire deviner un emoji mystère à toute la table", points: 20, emoji: "😶" },
    { id: 530, text: "Proposer un toast en langue étrangère improvisée", points: 25, emoji: "🌐" },
  ],
};
